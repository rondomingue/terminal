 ...
 * @returns {boolean}
 */
declare function isSupported(failIfMajorPerformanceCaveat?: boolean): boolean;
...
type ReadonlyMat2 = readonly [
	number,
	number,
	number,
	number
] | IndexedCollection;
type ReadonlyMat2d = readonly [
	number,
	number,
	number,
	number,
...
type ReadonlyQuat = readonly [
	number,
	number,
	number,
	number
] | IndexedCollection;
type ReadonlyQuat2 = readonly [
	number,
	number,
	number,
	number,
...
type ReadonlyVec2 = readonly [
	number,
	number
] | IndexedCollection;
type ReadonlyVec3 = readonly [
	number,
	number,
	number
] | IndexedCollection;
type ReadonlyVec4 = readonly [
	number,
	number,
	number,
	number
...
declare namespace VectorTileFeature {
	let types: [
		"Unknown",
		"Point",
		"LineString",
...
type FilterExpression = (globalProperties: GlobalProperties, feature: Feature$1, canonical?: CanonicalTileID$1, featureTileCoord?: Point, featureDistanceData?: FeatureDistanceData) => boolean;
type FeatureFilter = {
...
declare class EvaluationContext {
	...
	feature: Feature$1 | null | undefined;
...
declare class StyleExpression {
	...
	evaluateWithoutErrorHandling(globals: GlobalProperties, feature?: Feature$1, featureState?: FeatureState, canonical?: CanonicalTileID$1, availableImages?: ImageId[], formattedSection?: FormattedSection, featureTileCoord?: Point, featureDistanceData?: FeatureDistanceData): any;
	evaluate(globals: GlobalProperties, feature?: Feature$1, featureState?: FeatureState, canonical?: CanonicalTileID$1, availableImages?: ImageId[], formattedSection?: FormattedSection, featureTileCoord?: Point, featureDistanceData?: FeatureDistanceData, iconImageUseTheme?: string): any;
}
type ConstantExpression = {
	kind: "constant";
	configDependencies: Set<string>;
	isIndoorDependent: boolean;
	readonly evaluate: <T = unknown>(globals: GlobalProperties, feature?: Feature$1, featureState?: FeatureState, canonical?: CanonicalTileID$1, availableImages?: ImageId[], formattedSection?: FormattedSection, iconImageUseTheme?: string) => T;
};
type SourceExpression = {
	...
	configDependencies: Set<string>;
	readonly evaluate: <T = unknown>(globals: GlobalProperties, feature?: Feature$1, featureState?: FeatureState, canonical?: CanonicalTileID$1, availableImages?: ImageId[], formattedSection?: FormattedSection) => T;
};
type CameraExpression = {
	...
	isIndoorDependent: boolean;
	configDependencies: Set<string>;
	readonly evaluate: <T = unknown>(globals: GlobalProperties, feature?: Feature$1, featureState?: FeatureState, canonical?: CanonicalTileID$1, availableImages?: ImageId[]) => T;
...
declare class Feature$2 implements GeoJSONFeature {
	type: "Feature";
	id?: number | string;
 ...
 */
export declare class TargetFeature extends Feature$2 {
	variants: never;
	/**
	 ...
	 * @private
	 */
	constructor(feature: Feature$2, variant: FeatureVariant);
	toJSON(): Feature & FeatureVariant;
}
...
type SerializedSafeArea = {
	min: SerializedPoint;
	max: SerializedPoint;
};
type SerializedVec2Pair = [
	number,
	number
];
type SerializedElevationFeature = {
	...
	vertices?: Array<{
		position: SerializedVec2Pair;
		height: number;
		extent: number;
		index?: number;
	}>;
	vertexProps?: Array<{
		dir: SerializedVec2Pair;
	}>;
	edges?: Array<Edge>;
	edgeProps?: Array<{
		vec: SerializedVec2Pair;
		dir: SerializedVec2Pair;
		len: number;
	}>;
};
...
declare class ElevationFeature {
	...
	private tessellate;
	private distSqLines;
	static serialize(feature: ElevationFeature, _transferables?: Set<Transferable$1>): SerializedElevationFeature;
	static deserialize(input: SerializedElevationFeature): ElevationFeature;
}
declare class ElevationFeatureSampler {
	zScale: number;
	xOffset: number;
	yOffset: number;
...
declare class PossiblyEvaluatedPropertyValue<T> {
	...
	evaluate(feature: Feature$1, featureState: FeatureState, canonical?: CanonicalTileID, availableImages?: ImageId[], formattedSection?: FormattedSection): T;
}
...
declare class DataDrivenProperty<T> implements Property<T, PossiblyEvaluatedPropertyValue<T>> {
	...
	evaluate(value: PossiblyEvaluatedValue<T>, parameters: EvaluationParameters, feature: Feature$1, featureState: FeatureState, canonical?: CanonicalTileID, availableImages?: ImageId[], iconImageUseTheme?: string, formattedSection?: FormattedSection): T;
}
...
declare class PositionProperty implements Property<[
	...
	possiblyEvaluate(value: PropertyValue<[
		...
		number,
		number
	], Position$1>, parameters: EvaluationParameters): Position$1;
	interpolate(a: Position$1, b: Position$1, t: number): Position$1;
}
...
declare class AlphaImage {
	...
	clone(): AlphaImage;
	static copy(srcImg: AlphaImage, dstImg: AlphaImage, srcPt: Point$2, dstPt: Point$2, size: Size): void;
}
declare class RGBAImage {
	...
	clone(): RGBAImage;
	static copy(srcImg: RGBAImage | ImageData, dstImg: RGBAImage, srcPt: Point$2, dstPt: Point$2, size: Size, lut: LUT$1 | null, overrideRGBWithWhite?: boolean | null): void;
}
...
declare class UniformMatrix4f extends Uniform<mat4> implements IUniform<mat4> {
	constructor(context: Context);
	set(program: WebGLProgram, name: string, v: mat4): void;
}
declare class UniformMatrix3f extends Uniform<mat3> implements IUniform<mat3> {
	constructor(context: Context);
	set(program: WebGLProgram, name: string, v: mat3): void;
}
declare class UniformMatrix2f extends Uniform<mat2> implements IUniform<mat2> {
	constructor(context: Context);
	set(program: WebGLProgram, name: string, v: mat2): void;
}
...
declare class FeaturePositionMap {
	...
	indexed: boolean;
	constructor();
	add(id: string | number, index: number, start: number, end: number): void;
	eachPosition(id: string | number, fn: (index: number, start: number, end: number) => void): void;
 ...
 * @mixin Evented
 */
export declare class Evented<R extends EventRegistry = EventRegistry> {
...
declare class SymbolAppearance {
	...
	getUnevaluatedLayoutProperty(name: keyof AppearanceLayoutProps): PropertyValue<ResolvedImage, PossiblyEvaluatedPropertyValue<ResolvedImage>> | PropertyValue<number, PossiblyEvaluatedPropertyValue<number>> | PropertyValue<[
		number,
		number
	...
	getUnevaluatedPaintProperty(name: keyof AppearancePaintProps): PropertyValue<number, PossiblyEvaluatedPropertyValue<number>> | PropertyValue<[
		number,
		number
	], PossiblyEvaluatedPropertyValue<[
		number,
		number
	]>> | PropertyValue<Color, PossiblyEvaluatedPropertyValue<Color>> | PropertyValue<string, PossiblyEvaluatedPropertyValue<string>>;
...
declare class GridIndex<K = number> {
	width: number;
	height: number;
	xCellCount: number;
	yCellCount: number;
	...
	keysLength(): number;
	clear(): void;
	insert(key: K, x1: number, y1: number, x2: number, y2: number): void;
	insertCircle(key: K, x: number, y: number, radius: number): void;
	...
	static serialize(grid: GridIndex<number>, transferables?: Set<Transferable$1>): {
		buffer: ArrayBuffer;
	};
...
declare const RenderSourceType: {
	...
	readonly HdRoadCoverage: 3;
	readonly HdRoadElevation: 4;
};
...
declare class VertexArrayObject {
	context: Context;
	boundProgram: Program$1<UniformBindings> | null | undefined;
	...
	constructor();
	bind(context: Context, program: Program$1<UniformBindings>, layoutVertexBuffer: VertexBuffer, paintVertexBuffers: Array<VertexBuffer>, indexBuffer: IndexBuffer | null | undefined, vertexOffset: number | null | undefined, dynamicVertexBuffers: Array<VertexBuffer | null | undefined>, vertexAttribDivisorValue?: number | null): void;
	freshBind(program: Program$1<UniformBindings>, layoutVertexBuffer: VertexBuffer, paintVertexBuffers: Array<VertexBuffer>, indexBuffer: IndexBuffer | null | undefined, vertexOffset: number | null | undefined, dynamicVertexBuffers: Array<VertexBuffer | null | undefined>, vertexAttribDivisorValue?: number | null): void;
	destroy(): void;
}
type Segment = {
 ...
 */
export declare class FreeCameraOptions {
...
declare class Transform {
	 ...
	 */
	_findExtensionTilesInQuad(tiles: Array<OverscaledTileID>, maxZoom: number, corners: [
		vec3,
		vec3,
		vec3,
		vec3
	...
	getCameraToCenterDistance(projection: Projection$1, zoom?: number, worldSize?: number): number;
...
declare class Elevation {
	...
	static getAtTileOffsetFunc(tileID: OverscaledTileID, lat: number, worldSize: number, projection: Projection$1): (arg1: Point, arg2: Elevation, arg3?: ElevationFeature) => [
		number,
		number,
		number
	];
...
declare class QueryGeometry {
	 ...
	 */
	containsTile(tile: Tile, transform: Transform, use3D: boolean, cameraWrap: number, cameraMercator: MercatorCoordinate): TilespaceQueryGeometry | null | undefined;
	/**
...
declare class FillExtrusionStyleLayer extends StyleLayer {
	...
	createBucket(parameters: BucketParameters<this>): FillExtrusionBucket;
	queryRadius(): number;
...
type SerializedFootprintSegmentArray = {
	scalars: Uint32Array;
	rings: Array<Array<number>>;
};
declare class FootprintSegmentArray {
	data: Array<FootprintSegment>;
	constructor();
	get length(): number;
	push(s: FootprintSegment): void;
	get(i: number): FootprintSegment;
...
type SerializedPartDataArray = {
	buffer: Float64Array;
};
declare class PartDataArray {
	data: Array<PartData>;
	buffer: Float64Array | null;
	constructor();
	get length(): number;
	push(p: PartData): void;
	get(i: number): PartData;
	find(fn: (p: PartData) => boolean): PartData | undefined;
...
declare class GroundEffect {
	...
	addPaintPropertiesData(feature: Feature$1, index: number, imagePositions: SpritePositions, availableImages: ImageId[], canonical: CanonicalTileID, brightness?: number | null, worldview?: string): void;
...
declare class FrcCoveragePolygon {
	frcMask: number;
	rings: Array<Array<Point>>;
	constructor(frcMask?: number, rings?: Array<Array<Point>>);
	hasGeometry(): boolean;
}
type FrcCoveragePolygons = Array<FrcCoveragePolygon>;
interface FrcCoverageTile {
	tileId: CanonicalTileID;
	polygons: FrcCoveragePolygons;
	frcMask: number;
}
interface FrcCoverageSnapshot {
...
declare function loadGlyphRange(fontstack: string, range: number, urlTemplate: string, requestManager: RequestManager, callback: Callback<GlyphRange>): Promise<void>;
/**
...
declare class GlyphLoader {
	private pendingRequests;
	private cachedRanges;
	private fontstackCompositing;
	static loadGlyphRange: typeof loadGlyphRange;
	constructor(options?: GlyphLoaderOptions);
	loadGlyphRange(fontstack: string, range: number, urlTemplate: string, requestManager: RequestManager, callback: Callback<GlyphRange>): void;
	private _loadMultipleFonts;
	private _loadFont;
	private _composeGlyphs;
}
...
type SpriteFormat = "auto" | "icon_set" | "raster";
type ImageRequestor = {
	ids: ImageId[];
	scope: string;
	callback: Callback<{
...
declare class ImageManager extends Evented {
	...
	rasterizeImages(params: MainInbox["rasterizeImages"]["params"], callback: Callback<MainInbox["rasterizeImages"]["result"]>): void;
...
declare class StyleChanges {
	 ...
	 */
	getLayerUpdatesByScope(): Record<string, {
...
declare class LayerExpressionDependencies {
	_layer: StyleLayer;
...
declare class SymbolPropertiesUBO {
	...
	static readonly EVAL_FLAT_OFFSETS: readonly number[];
	static readonly EVAL_FLAT_ZOOM_OFFSETS: readonly number[];
	static readonly EVAL_FLAT_TOTAL = 42;
	private static _blockIndicesTemplate;
	private static getBlockIndices;
	propsDwords: number;
	totalBytes: number;
...
declare class SymbolStyleLayer extends StyleLayer {
	...
	getValueAndResolveTokens<T extends keyof LayoutProps$1>(name: T, feature: Feature$1, canonical: CanonicalTileID, availableImages: ImageId[]): string;
	getAppearanceValueAndResolveTokens<T extends keyof AppearanceProps>(appearance: SymbolAppearance, name: T, feature: Feature$1, canonical: CanonicalTileID, availableImages: ImageId[]): string | LayoutProps$1[T];
	createBucket(parameters: BucketParameters<this>): SymbolBucket;
	queryRadius(): number;
	queryIntersectsFeature(): boolean;
	_setPaintOverrides(): void;
	_handleOverridablePaintPropertyUpdate<T, R>(name: string, oldValue: PropertyValue<T, R>, newValue: PropertyValue<T, R>): boolean;
	static hasPaintOverride(layout: PossiblyEvaluated<LayoutProps$1>, propertyName: string): boolean;
	getProgramIds(): ProgramName[];
	getDefaultProgramParams(name: string, zoom: number, lut: LUT$1 | null): CreateProgramParams | null;
	hasElevation(): boolean;
	mayUse(type: RuntimeModuleType): boolean;
...
declare class SymbolPropertyBinderUBO {
	...
	allFeatureVtIndices: number[];
	allFeatureIds: Array<string | number | undefined>;
	 ...
	 */
	private _recomputeSharedRanges;
	/**
	 ...
	 *   zoom-dep → [min, max]
	 */
	evaluateAllProperties(feature: Feature$1, featureState: FeatureState, canonical: CanonicalTileID, availableImages: ImageId[], brightness?: number | null, formattedSection?: FormattedSection, activeAppearance?: SymbolAppearance | null): Float32Array;
	/**
	...
	private _unbakeCamera;
	private _layerUnevaluated;
	/**
	 ...
	 */
	private _writeFeatureBlock;
	private _batchExceedsDeviceLimit;
	/**
	 ...
	 */
	private _ensureRangeMaps;
	/**
	 * Populates a UBO entry for a feature and returns its local index within the batch.
	 */
	populateUBO(feature: Feature$1, vtFeatureIndex: number, canonical: CanonicalTileID, availableImages: ImageId[], brightness?: number | null, formattedSection?: FormattedSection): number;
	/**
	 ...
	 */
	updateFeaturePaintForAppearance(vtFeatureIndex: number, feature: Feature$1, featureState: FeatureState, canonical: CanonicalTileID, availableImages: ImageId[], brightness: number | null | undefined, activeAppearance: SymbolAppearance | null | undefined): boolean;
	/**
...
declare class SymbolHDExtension {
...
declare class SymbolBuffers {
	...
	restoreIconTransitioningVertexData(offset: number, snapshot: Uint16Array): void;
...
declare class SymbolBucket implements Bucket {
	...
	hasRTLText: boolean;
	projection: ProjectionSpecification;
	projectionInstance: Projection$1 | null | undefined;
	...
	populate(features: Array<IndexedFeature>, options: PopulateParameters, canonical: CanonicalTileID, tileTransform: TileTransform): void;
	getCombinedIconVariants(appearance: SymbolAppearance, layer: SymbolStyleLayer, evaluationFeature: EvaluationFeature, canonical: CanonicalTileID, availableImages: ImageId[], symbolFeature: SymbolFeature, iconScaleFactor: number): {
		iconPrimary: ImageVariant | undefined;
		iconSecondary: ImageVariant | undefined;
	};
...
export declare const getRTLTextPluginStatus: () => PluginStatus;
declare const registerForPluginStateChange: (callback: PluginStateSyncCallback) => PluginStateSyncCallback;
export declare const setRTLTextPlugin: (url: string, callback?: Callback<{
...
interface CollisionDetector {
	placeCollisionBox: (bucket: SymbolBucket, scale: number, collisionBox: SingleCollisionBox, mercatorCenter: [
		number,
		number
	], invMatrix: mat4, projectedPosOnLabelSpace: boolean, shift: Point, allowOverlap: boolean, textPixelRatio: number, posMatrix: mat4, collisionGroupPredicate?: CollisionGroup["predicate"]) => PlacedCollisionBox;
	...
	projectAndGetPerspectiveRatio: (posMatrix: mat4, x: number, y: number, z: number, tileID: OverscaledTileID | null | undefined, checkOcclusion: boolean, bucketProjection: Projection$1) => ScreenAnchorPoint;
...
interface PlacementAlgorithm {
	createCollisionDetector: (transform: Transform, fogState?: FogState | null, prevCollisionADetector?: CollisionDetector | null) => CollisionDetector;
	placeLayerBucketPart: (placement: Placement, bucketPart: BucketPart, seenCrossTileIDs: Set<number>, showCollisionBoxes: boolean, updateCollisionBoxIfNecessary: boolean, scaleFactor: number) => void;
...
declare const algorithms: Record<string, PlacementAlgorithm>;
type PlacementAlgorithmName = keyof typeof algorithms;
...
declare class PauseablePlacement {
	...
	_retiredCI: CollisionDetector | null;
	startNewPlacement(transform: Transform, order: Array<string>, showCollisionBoxes: boolean, fadeDuration: number, crossSourceCollisions: boolean, prevPlacement?: Placement, fogState?: FogState | null, buildingIndex?: BuildingIndex | null, placementAlgorithmName?: PlacementAlgorithmName): PauseablePlacement;
...
declare class CrossTileSymbolIndex {
	...
	constructor();
	addLayer(styleLayer: TypedStyleLayer, tiles: Array<Tile>, lng: number, projection: Projection$1): boolean;
...
declare class ProgramPrecompiler {
	...
	constructor();
	needsBuild(): boolean;
	buildQueue(layers: TypedStyleLayer[], parameters: EvaluationParameters, style: Style): void;
	_executeBatch(deadline: IdleDeadline, painter: Painter, style: Style): void;
	processQueue(painter: Painter, style: Style): void;
	reset(): void;
}
...
declare class IndoorManager extends Evented<IndoorEvents> {
	...
	constructor(style: Style, styleLoaded?: boolean);
	destroy(): void;
...
export declare class CustomSource<T> extends Evented<SourceEvents> implements ISource {
	...
	loadTile(tile: Tile, callback: Callback<undefined>): Promise<void>;
...
export declare class ImageSource<T = "image"> extends Evented<SourceEvents> implements ISource<T> {
	...
	load(newCoordinates?: Coordinates, loaded?: boolean): Promise<void>;
	loaded(): boolean;
	/**
 ...
 * @private
 */
export declare function addTileProvider(name: string, url: string): void;
/**
...
export declare class RasterTileSource<T = "raster"> extends Evented<SourceEvents> implements ISource<T> {
	...
	loadTileJSONWithProvider(tileProvider: {
		name: string;
		url: string;
	}, callback: Callback<TileJSON>): Cancelable;
	loaded(): boolean;
	onAdd(map: Map$1): void;
	/**
	...
	hasTile(tileID: OverscaledTileID): boolean;
	loadTile(tile: Tile, callback: Callback<undefined>): Promise<void>;
	loadTileWithProvider(tile: Tile, provider: TileProvider<ArrayBuffer | ImageBitmap>, url: string, controller: AbortController, callback: Callback<undefined>): Promise<void>;
	abortTile(tile: Tile, callback?: Callback<undefined>): void;
	unloadTile(tile: Tile, callback?: Callback<undefined>): void;
	hasTransition(): boolean;
...
declare class RasterArrayTile extends Tile implements Tile {
	 ...
	 */
	flushAllQueues(): void;
	fetchHeader(fetchLength: number | null | undefined, callback: ResponseCallback<ArrayBuffer | null | undefined>): AbortController;
...
export declare class RasterArrayTileSource extends RasterTileSource<"raster-array"> {
	...
	loadTile(tile: RasterArrayTile, callback: Callback<undefined>): Promise<void>;
...
type AnyLayer = Omit<LayerSpecification, "source"> & AnyLayerSource | CustomLayerInterface;
...
type LayerProperty = LayerBaseSpecification & PaintSpecification & LayoutSpecification;
/**
 * @private
 */
export declare class Style extends Evented<MapEvents> {
	map: Map$1;
	...
	_hdCoverage: InstanceType<NonNullable<typeof HD$1.HdCoverageState>> | null;
	_hdElevation: InstanceType<NonNullable<typeof HD$1.HdElevationState>> | null;
	...
	getImportGlobalIds(style?: Style, ids?: Set<string>): string[];
	_createFragmentStyle(importSpec: ImportSpecification): Style;
	_reloadImports(initialLoad?: boolean): void;
	...
	mergeAll(): void;
	forEachFragmentStyle(fn: (style: Style) => void): void;
	 ...
	 */
	_updateWorkerImages(isSpriteLoaded?: boolean): void;
	...
	setIndoorData(mapId: undefined, params: MainInbox["setIndoorData"]["params"]): void;
	...
	_updateLayers(layerIds: Iterable<string>): void;
	 ...
	 * @returns {Map} The {@link Map} object.
	 */
	addLayer(layerObject: AnyLayer, before?: string, options?: StyleSetterOptions): void;
	/**
	...
	setLayerProperty<K extends keyof LayerProperty>(layerId: string, name: K, value: LayerProperty[K], options?: StyleSetterOptions): void;
	/**
	...
	_flattenAndSortRenderedFeatures(sourceResults: Array<QueryResult>): Array<Feature$2>;
	...
	queryRenderedTargets(queryGeometry: PointLike | [
		PointLike,
		PointLike
	], targets: QrfTarget[], transform: Transform): Feature$2[];
	...
	_reloadSources(): void;
	updateFrcCoverageFadeRange(): void;
	updateFrcCoverage(): void;
	updateElevationCoverage(): void;
	_handleLayerOrderChange(): void;
	_requestFullLabelPlacement(): void;
	_setLabelPlacementStale(): void;
	_updatePlacement(transform: Transform, showCollisionBoxes: boolean, fadeDuration: number, crossSourceCollisions: boolean, replacementSource: ReplacementSource, placementAlgorithmName?: PlacementAlgorithmName): boolean;
	...
	destroy(): void;
	getImages(mapId: undefined, params: MainInbox["getImages"]["params"]): Promise<MainInbox["getImages"]["result"]>;
	rasterizeImages(mapId: undefined, params: MainInbox["rasterizeImages"]["params"]): Promise<MainInbox["rasterizeImages"]["result"]>;
	checkAtlasCache(mapId: undefined, params: MainInbox["checkAtlasCache"]["params"]): Promise<MainInbox["checkAtlasCache"]["result"]>;
	getGlyphs(mapId: undefined, params: MainInbox["getGlyphs"]["params"]): Promise<MainInbox["getGlyphs"]["result"]>;
}
declare class Dispatcher {
	...
	constructor(workerPool: WorkerPool, style: Style, name?: string, count?: number);
	/**
	 ...
	 * @private
	 */
	send<T extends keyof WorkerInbox>(type: T, data: WorkerInbox[T]["params"], options?: {
		signal?: AbortSignal;
	}): Promise<Array<WorkerInbox[T]["result"]>>;
	/**
...
type ElevationCoverageTile = {
	sourceFQID: string;
	tileId: CanonicalTileID;
	features: ElevationFeature[];
	generation: number;
};
interface ElevationCoverageSnapshot {
...
declare class DedupedRequest {
	...
	constructor(scheduler?: Scheduler$1);
...
type FeatureCollectionOrFeature = FeatureCollection | Feature;
...
export declare class GeoJSONSource extends Evented<SourceEvents> implements ISource {
	 ...
	 * });
	 */
	setData(data: GeoJSON$1 | string): this;
	/**
	 ...
	 * });
	 */
	updateData(data: GeoJSON$1 | string): this;
	/**
	 ...
	 * });
	 */
	getClusterChildren(clusterId: number, callback: Callback<Array<Feature>>): this;
	/**
	 ...
	 * });
	 */
	getClusterLeaves(clusterId: number, limit: number, offset: number, callback: Callback<Array<Feature>>): this;
	_updateWorkerData(append?: boolean): Promise<void>;
	loaded(): boolean;
	reload(): void;
	loadTile(tile: Tile, callback: Callback<undefined>): void;
...
type MainInbox = {
	...
	"rasterizeImages": {
		params: {
			scope: string;
			iconTasks: ImageRasterizationTasks;
			patternTasks: ImageRasterizationTasks;
		};
...
type ActorInbox = WorkerInbox & MainInbox;
type ActorMessage = keyof WorkerInbox | keyof MainInbox;
...
declare class Actor<Outbox extends MessageMap> {
	target: Worker;
	parent: ActorParent;
	name?: string;
	mapId?: number;
	 ...
	 * @private
	 */
	send<T extends keyof Outbox>(type: T, data: Outbox[T]["params"], options?: {
		signal?: AbortSignal;
		targetMapId?: number;
		metadata?: TaskMetadata;
	}): Promise<Outbox[T]["result"]>;
	/**
	 * Sends a message without awaiting for response. Use {@link Actor#send} if you need to await a response.
	 * @private
	 */
	notify<T extends keyof Outbox>(type: T, data: Outbox[T]["params"], options?: {
		targetMapId?: number;
	}): void;
	/**
	 ...
	 * @private
	 */
	sendCancelable<T extends keyof Outbox>(type: T, data: Outbox[T]["params"], options: {
		targetMapId?: number;
		metadata?: TaskMetadata;
	}, callback: (err?: Error | null, result?: Outbox[T]["result"]) => void): AbortController;
	/**
	...
	processTask(id: string, task: Task$1): Promise<void>;
	remove(): void;
}
type DashRange = {
	isDash: boolean;
...
declare class BuildingStyleLayer extends StyleLayer {
	...
	mayUse(type: RuntimeModuleType): boolean;
	prepare(): Promise<void>;
	createBucket(parameters: BucketParameters<this>): BuildingBucket;
	cutoffRange(): number;
	hasShadowPass(): boolean;
	...
	queryIntersectsFeature(queryGeometry: TilespaceQueryGeometry, feature: VectorTileFeature, featureState: FeatureState, geometry: Array<Array<Point>>, zoom: number, transform: Transform, pixelPosMatrix: Float32Array, elevationHelper: DEMSampler | null | undefined, layoutVertexArrayOffset: number, scope: string | undefined): boolean | number;
}
declare function draw(painter: Painter, source: SourceCache, layer: BuildingStyleLayer, coords: Array<OverscaledTileID>): void;
...
declare function drawRasterParticle(painter: Painter, sourceCache: SourceCache, layer: RasterParticleStyleLayer, tileIDs: Array<OverscaledTileID>, _: unknown, isInitialLoad: boolean): void;
declare function prepare(layer: RasterParticleStyleLayer, sourceCache: SourceCache, _: Painter): void;
type VignetteParams = {
	strength: number;
	start: number;
	range: number;
...
declare class Movement {
	...
	constructor();
	update(tr: Transform, ppmScaleFactor: number): void;
	getPosition(): vec3;
}
...
type Callback$1 = (value?: unknown) => void;
type DevToolsFolder = {
	addBinding: <T extends object>(target: T, key: keyof T, params?: Record<string, unknown>, callback?: Callback$1) => void;
...
type PrecipitationRevealParams = {
	revealStart: number;
	revealRange: number;
};
type RainDrawParams = {
...
declare class FillBufferData {
	...
	uploaded: boolean;
	constructor(layers: Array<FillStyleLayer>, zoom: number, lut: LUT$1 | null);
...
declare class ElevatedFillBufferData extends FillBufferData {
	elevatedLayoutVertexArray: StructArrayLayout1f4;
...
interface FeatureTriSegment {
	start: number;
	end: number;
	segIdx: number;
	frc: number | null;
}
declare class FrcSegmentData {
...
declare class FillHDExtension {
	 ...
	 */
	handleFeature(feature: BucketFeature, polygons: Point[][][], index: number, canonical: CanonicalTileID, elevationFeatures: ElevationFeature[] | undefined, bucket: FillBucket): boolean;
	populatePaintArrays(feature: BucketFeature, index: number, imagePositions: SpritePositions, availableImages: ImageId[], canonical: CanonicalTileID, brightness: number | null | undefined, worldview: string): void;
	update(states: FeatureStates, vtLayer: VectorTileLayer, availableImages: ImageId[], imagePositions: SpritePositions, layers: ReadonlyArray<TypedStyleLayer>, isBrightnessChanged: boolean, brightness: number | null | undefined, worldview: string): void;
	updateExpressions(layers: ReadonlyArray<TypedStyleLayer>): void;
	upload(context: Context): void;
	destroy(): void;
	getUnevaluatedPortalGraph(): ElevationPortalGraph | undefined;
	setEvaluatedPortalGraph(graph: ElevationPortalGraph, vtLayer: VectorTileLayer, canonical: CanonicalTileID, availableImages: ImageId[], brightness: number | null | undefined, worldview: string): void;
...
declare class FillBucket implements Bucket {
	 ...
	 * @private
	 */
	addGeometry(polygons: Point[][][], bufferData: FillBufferData, elevationParams?: ElevationParams$1, elevatedStructures?: ElevatedStructures): [
		number,
		number
	];
}
...
declare class FillStyleLayer extends StyleLayer {
	...
	getDefaultProgramParams(name: string, zoom: number, lut: LUT$1 | null): CreateProgramParams | null;
	recalculate(parameters: EvaluationParameters, availableImages: ImageId[]): void;
	createBucket(parameters: BucketParameters<this>): FillBucket;
	queryRadius(): number;
...
declare function drawElevatedStructures(params: DrawFillParams): void;
declare function drawElevatedFillShadows(params: DrawFillParams): void;
declare function drawDepthPrepass(painter: Painter, sourceCache: SourceCache | undefined, layer: FillStyleLayer, coords: Array<OverscaledTileID>, pass: DepthPrePass): void;
declare function drawGroundShadowMask(painter: Painter, sourceCache: SourceCache | undefined, layer: FillStyleLayer, coords: Array<OverscaledTileID>): void;
declare class FrcCoverageSnapshot$1 implements FrcCoverageSnapshot {
	tiles: Array<FrcCoverageTile>;
...
declare class FrcCoverageManager {
	_tileCoverages: Array<FrcCoverageTile>;
	_snapshot: FrcCoverageSnapshot$1;
	constructor();
	clear(): void;
	addTileCoverage(tileId: CanonicalTileID, polygons: FrcCoveragePolygons): void;
	empty(): boolean;
	updateSnapshotIfNeeded(): FrcCoverageSnapshot$1;
}
declare function updateFrcCoverageFadeRange(style: Style, painter: Painter): void;
declare class HdCoverageState {
	coverageSourceCaches: Record<string, SourceCache>;
	manager: FrcCoverageManager;
	constructor();
}
declare function updateFrcCoverage(style: Style, state: HdCoverageState): void;
declare function updateHdCoverageSourceCache(style: Style, state: HdCoverageState, layer: TypedStyleLayer): void;
declare class ElevationCoverageSnapshot$1 implements ElevationCoverageSnapshot {
	tiles: ElevationCoverageTile[];
...
declare function buildElevationRequestParams(map: Map$1, tile: Tile, crossSourceElevationEnabled: boolean): ElevationParams | null;
declare class ElevationCoverageManager {
	_tiles: ElevationCoverageTile[];
	_snapshot: ElevationCoverageSnapshot$1;
	_snapshotChanged: boolean;
	constructor();
	clear(): void;
	consumeSnapshotChanged(): boolean;
	addTileElevation(sourceFQID: string, tileId: CanonicalTileID, features: ElevationFeature[], generation: number): void;
	updateSnapshotIfNeeded(): ElevationCoverageSnapshot$1;
}
/**
...
export declare class VectorTileSource extends Evented<SourceEvents> implements ISource<"vector"> {
	...
	loadTile(tile: Tile, callback: Callback<WorkerSourceVectorTileResult | null>): Promise<void>;
...
declare function updateCrossSourceElevationGate(style: Style): void;
declare function markElevationIngestSourceCachesUsed(style: Style): void;
declare class HdElevationState {
...
declare function setupAndUpdateElevationCoverage(style: Style): void;
declare function updateHdElevationSourceCache(style: Style, state: HdElevationState, source: VectorTileSource): void;
declare function updateElevationCoverage(style: Style, state: HdElevationState): void;
interface CoverageTileBuffers {
	vertexBuffer: VertexBuffer;
	indexBuffer: IndexBuffer;
	frcLevelSegments: Array<SegmentVector | null>;
}
declare class FrcCoverageRenderer {
	tileBuffers: Map<string, CoverageTileBuffers>;
	_context: Context | null;
	constructor();
	update(context: Context, coverageTiles: Array<FrcCoverageTile>): void;
...
declare class LineHDExtension {
	 ...
	 */
	handleFeature(feature: BucketFeature, geometry: Array<Array<Point>>, canonical: CanonicalTileID, elevationFeatures: ElevationFeature[] | undefined, elevationParams: ElevationParams | null | undefined, crossSourceElevationEnabled: boolean, join: string, cap: string, miterLimit: number, roundLimit: number, bucket: LineBucket): boolean;
...
declare class LineBucket implements Bucket {
	...
	zOffsetVertexArray: StructArrayLayout4f16;
	zOffsetVertexBuffer: VertexBuffer;
	elevationIdColVertexArray: StructArrayLayout3f12;
	...
	addFeature(feature: BucketFeature, geometry: Array<Array<Point>>, index: number, canonical: CanonicalTileID, imagePositions: SpritePositions, availableImages: ImageId[], brightness?: number | null, elevationFeatures?: ElevationFeature[], elevationParams?: ElevationParams | null, crossSourceElevationEnabled?: boolean): void;
	/**
	 * @private
	 */
	fillNonElevatedRoadSegment(vertexOffset: number): void;
...
declare class LineBlendFbos {
	fbo: Framebuffer | null | undefined;
	drapeFbo: Framebuffer | null | undefined;
	destroy(): void;
}
declare class LineBlendDensityReadback {
	pbo: WebGLBuffer;
	sync: WebGLSync | null;
...
declare class LineStyleLayer extends StyleLayer {
	...
	recalculate(parameters: EvaluationParameters, availableImages: ImageId[]): void;
	createBucket(parameters: BucketParameters<this>): LineBucket;
	getProgramIds(): ProgramName[];
	getDefaultProgramParams(name: string, zoom: number, lut: LUT$1 | null): CreateProgramParams | null;
	queryRadius(bucket: Bucket): number;
	queryIntersectsFeature(queryGeometry: TilespaceQueryGeometry, feature: VectorTileFeature, featureState: FeatureState, geometry: Array<Array<Point>>, zoom: number, transform: Transform): boolean;
	...
	onRemove(map: Map$1): void;
	_clear(): void;
	_destroyLineBlendFbo(gl?: WebGL2RenderingContext): void;
}
interface FillCoverageTileInfo {
	coord: OverscaledTileID;
	bufferData: FillBufferData;
	program: Program$1<UniformBindings>;
...
declare function drawFillFrcCoverageSecondPass(painter: Painter, layer: FillStyleLayer, tiles: FillCoverageTileInfo[], drawMode: DrawMode, colorMode: Readonly<ColorMode>): void;
...
declare function drawLineFrcCoverageSecondPass(painter: Painter, layer: LineStyleLayer, tiles: LineCoverageTileInfo[]): void;
type FillFrcFirstPassResult = "drawn" | "deferred" | "skip" | "fallthrough";
interface FillFrcCoverageFirstPassParams {
	painter: Painter;
	layer: FillStyleLayer;
	bucket: FillBucket;
	coord: OverscaledTileID;
...
declare function drawFillFrcCoverageFirstPass(p: FillFrcCoverageFirstPassParams): FillFrcFirstPassResult;
interface LineFrcCoverageContext {
	coverageTile: FrcCoverageTile;
	frcMask: number;
	active: boolean;
	hasPolygonGeometry: boolean;
}
declare function drawLineFrcCoverageDetect(painter: Painter, bucket: LineBucket, coord: OverscaledTileID, elevated: boolean, uniformValues: UniformValues<UniformBindings>, programConfiguration: ProgramConfiguration, program: Program$1<UniformBindings>, depthMode: Readonly<DepthMode>, colorMode: Readonly<ColorMode>, polygonCoverageTiles: LineCoverageTileInfo[]): LineFrcCoverageContext | null;
declare function drawLineFrcRenderLine(bucket: LineBucket, ctx: LineFrcCoverageContext, stencilMode: Readonly<StencilMode>, drawWithSegments: (stencilMode: Readonly<StencilMode>, segs: SegmentVector | undefined, opacityMultiplier?: number) => void): void;
declare function drawLineFrcFadePass(painter: Painter, bucket: LineBucket, coord: OverscaledTileID, ctx: LineFrcCoverageContext, elevated: boolean, stencilMode3D: Readonly<StencilMode>, drawWithSegments: (stencilMode: Readonly<StencilMode>, segs: SegmentVector | undefined, opacityMultiplier?: number) => void): void;
type LayoutProps$5 = {
...
declare class CircleStyleLayer extends StyleLayer {
	...
	constructor(layer: LayerSpecification, scope: string, lut: LUT$1 | null, options?: ConfigOptions | null);
	createBucket(parameters: BucketParameters<this>): CircleBucket<CircleStyleLayer>;
	queryRadius(bucket: Bucket): number;
...
declare class HeatmapStyleLayer extends StyleLayer {
	...
	createBucket(parameters: BucketParameters<this>): HeatmapBucket;
	constructor(layer: LayerSpecification, scope: string, lut: LUT$1 | null, options?: ConfigOptions | null);
	_handleSpecialPaintPropertyUpdate(name: string): void;
	_updateColorRamp(): void;
	resize(): void;
...
declare class CircleBucket<Layer extends CircleStyleLayer | HeatmapStyleLayer = CircleStyleLayer | HeatmapStyleLayer> implements Bucket {
	...
	upload(context: Context): void;
	destroy(): void;
	addFeature(feature: BucketFeature, geometry: Array<Array<Point>>, index: number, availableImages: ImageId[], canonical: CanonicalTileID, projection?: Projection$1 | null, brightness?: number | null, elevationFeatures?: ElevationFeature[]): void;
	private addCircleVertex;
	private addGlobeExtVertex;
}
declare class CircleHDExtension {
	elevatedLayoutVertexArray: StructArrayLayout1f4 | undefined;
	elevatedLayoutVertexBuffer: VertexBuffer | undefined;
	hasElevation: boolean;
	private currentFeatureElevation;
	constructor();
	beginFeature(feature: BucketFeature, elevationFeatures: ElevationFeature[] | undefined, canonical: CanonicalTileID): void;
...
declare const HD: {
	loaded: boolean;
	drawBuilding: typeof draw;
	BuildingTileBorderManager: typeof BuildingTileBorderManager;
	drawRasterParticle: typeof drawRasterParticle;
	prepareRasterParticle: typeof prepare;
	Rain: typeof Rain$1;
	Snow: typeof Snow$1;
	shaders: {
		building: ShaderSource;
		buildingBloom: ShaderSource;
		buildingDepth: ShaderSource;
		rasterParticle: ShaderSource;
		rasterParticleDraw: ShaderSource;
		rasterParticleTexture: ShaderSource;
		rasterParticleUpdate: ShaderSource;
		snowParticle: ShaderSource;
		rainParticle: ShaderSource;
		vignette: ShaderSource;
		elevatedStructuresDepth: ShaderSource;
		elevatedStructures: ShaderSource;
		elevatedStructuresDepthReconstruct: ShaderSource;
	};
	programUniforms: {
	...
	drawElevatedStructures: typeof drawElevatedStructures;
	drawElevatedFillShadows: typeof drawElevatedFillShadows;
	drawDepthPrepass: typeof drawDepthPrepass;
	drawGroundShadowMask: typeof drawGroundShadowMask;
	IndoorManager: typeof IndoorManager;
	HdCoverageState: typeof HdCoverageState;
	updateFrcCoverage: typeof updateFrcCoverage;
	updateHdCoverageSourceCache: typeof updateHdCoverageSourceCache;
	updateFrcCoverageFadeRange: typeof updateFrcCoverageFadeRange;
	HdElevationState: typeof HdElevationState;
	setupAndUpdateElevationCoverage: typeof setupAndUpdateElevationCoverage;
	updateElevationCoverage: typeof updateElevationCoverage;
	updateHdElevationSourceCache: typeof updateHdElevationSourceCache;
	markElevationIngestSourceCachesUsed: typeof markElevationIngestSourceCachesUsed;
	updateCrossSourceElevationGate: typeof updateCrossSourceElevationGate;
	buildElevationRequestParams: typeof buildElevationRequestParams;
	FrcCoverageRenderer: typeof FrcCoverageRenderer;
	drawFillFrcCoverageFirstPass: typeof drawFillFrcCoverageFirstPass;
	drawFillFrcCoverageSecondPass: typeof drawFillFrcCoverageSecondPass;
	drawLineFrcCoverageDetect: typeof drawLineFrcCoverageDetect;
	drawLineFrcRenderLine: typeof drawLineFrcRenderLine;
	drawLineFrcFadePass: typeof drawLineFrcFadePass;
	drawLineFrcCoverageSecondPass: typeof drawLineFrcCoverageSecondPass;
};
declare const HD$1: Partial<typeof HD>;
...
type SymbolDefinesType = "COLOR_ADJUSTMENT" | "ICON_TRANSITION" | "PITCH_WITH_MAP_TERRAIN" | "PROJECTED_POS_ON_VIEWPORT" | "RENDER_TEXT_AND_SYMBOL" | "Z_OFFSET" | "APPLY_LUT_ON_GPU";
...
type LineDefinesType = "RENDER_LINE_GRADIENT" | "RENDER_LINE_DASH" | "RENDER_LINE_TRIM_OFFSET" | "RENDER_LINE_BORDER" | "LINE_JOIN_NONE" | "ELEVATED" | "ELEVATED_ROADS" | "VARIABLE_LINE_WIDTH" | "VARIABLE_LINE_EMISSIVE_STRENGTH" | "CROSS_SLOPE_VERTICAL" | "CROSS_SLOPE_HORIZONTAL" | "ELEVATION_REFERENCE_SEA" | "ELEVATION_GROUND_SCALE" | "LINE_PATTERN_TRANSITION" | "USE_MRT1" | "DUAL_SOURCE_BLENDING" | "LINE_BLEND_MULTIPLY" | "LINE_BLEND_ADDITIVE" | "DEBUG_ELEVATION_ID";
...
declare class Terrain$1 extends Elevation {
	...
	update(style: Style, transform: Transform, adaptCameraAltitude: boolean): void;
...
declare class ModelStyleLayer extends StyleLayer {
	...
	mayUse(type: RuntimeModuleType): boolean;
	prepare(): Promise<void>;
	createBucket(parameters: BucketParameters<this>): ModelBucket;
	getProgramIds(): ProgramName[];
	is3D(terrainEnabled?: boolean): boolean;
	hasShadowPass(): boolean;
	canCastShadows(): boolean;
	...
	cutoffRange(): number;
	queryRadius(bucket: Bucket): number;
	queryRenderedFeatures(queryGeometry: QueryGeometry, sourceCache: SourceCache, transform: Transform): QueryResult;
	queryIntersectsFeature(queryGeometry: TilespaceQueryGeometry, feature: VectorTileFeature, featureState: FeatureState, geometry: Array<Array<Point>>, zoom: number, transform: Transform, pixelPosMatrix: Float32Array, elevationHelper: DEMSampler | null | undefined, layoutVertexArrayOffset: number, scope: string | undefined): number | boolean;
	_handleOverridablePaintPropertyUpdate<T, R>(name: string, oldValue: PropertyValue<T, R>, newValue: PropertyValue<T, R>): boolean;
...
type ModelDefinesType = "DIFFUSE_SHADED" | "SHADOWS_SINGLE_CASCADE" | "OCCLUSION_TEXTURE_TRANSFORM" | "DITHERED_DISCARD";
...
declare class ShadowRenderer {
	...
	setupShadowsFromCascadeMatrices(perCascadeMatrices: mat4[], program: Program$1<ShadowUniformsType | ModelUniformsType | BuildingUniformsType>, normalOffset?: boolean): void;
...
declare const programUniforms$1: {
...
type ProgramUniformsStandardType = {
	[K in keyof typeof programUniforms$1]: ReturnType<typeof programUniforms$1[K]>;
};
...
type LineBlendReduceUniformsType = {
	["u_image"]: Uniform1i;
...
type GlobalDefinesType = "DEBUG_WIREFRAME" | "FOG" | "GLOBE" | "LIGHTING_3D_ALPHA_EMISSIVENESS" | "LIGHTING_3D_MODE" | "NORMAL_OFFSET" | "OVERDRAW_INSPECTOR" | "RENDER_CUTOFF" | "RENDER_SHADOWS" | "RENDER_TO_TEXTURE" | "TERRAIN_DEM_FLOAT_FORMAT" | "TERRAIN" | "TERRAIN_VERTEX_MORPHING";
...
declare const programUniforms$2: {
	...
	readonly lineBlendReduce: (context: Context) => LineBlendReduceUniformsType;
...
type ProgramUniformsType = {
	[K in keyof typeof programUniforms$2]: ReturnType<typeof programUniforms$2[K]>;
} & ProgramUniformsHDType & ProgramUniformsStandardType;
type RenderPass = "offscreen" | "opaque" | "translucent" | "sky" | "shadow" | "light-beam";
type DepthPrePass = "initialize" | "reset" | "geometry";
...
declare class Painter {
	...
	glyphManager: GlyphManager;
	modelManager: ModelManager;
	buildingTileBorderManager?: InstanceType<NonNullable<typeof HD$1.BuildingTileBorderManager>>;
	...
	_rain?: InstanceType<NonNullable<typeof HD$1.Rain>>;
	_snow?: InstanceType<NonNullable<typeof HD$1.Snow>>;
	...
	updateTerrain(style: Style, adaptCameraAltitude: boolean): void;
	_updateFog(style: Style): void;
	...
	getShaderSource(name: ProgramName): ShaderSource;
	setCustomLayerDefaults(): void;
	setBaseState(): void;
	initDebugOverlayCanvas(): void;
	destroy(): void;
	prepareDrawTile(): void;
	uploadCommonLightUniforms(context: Context, program: Program$1<LightsUniformsType>, lightOverrides?: LightOverrides): void;
	uploadCommonUniforms(context: Context, program: Program$1<ProgramUniformsType[ProgramName]>, tileID?: UnwrappedTileID | null, fogMatrix?: mat4 | null, cutoffParams?: CutoffParams | null, lightOverrides?: LightOverrides): void;
...
declare class SourceCache extends Evented {
	...
	*/
	 ...
	 */
	update(transform: Transform, tileSize?: number, updateForTerrain?: boolean, directionalLight?: vec3, elevatedLayers?: boolean): void;
	 ...
	 * @returns {Object} Returns `this` | Promise.
	 */
	_preloadTiles(transform: Transform | Array<Transform>, callback: Callback<Tile[]>): void;
}
type QrfQuery = {
	layers: QrfLayers;
	sourceCache: SourceCache;
...
declare class FeatureIndex$1 {
	...
	loadMatchingModelFeature(result: QueryResult, featureIndexData: FeatureIndices, query: QrfQuery, tilespaceGeometry: TilespaceQueryGeometry, transform: Transform, worldview: string | undefined): void;
	updateFeatureProperties(feature: Feature$2, target: QrfTarget, availableImages?: ImageId[]): void;
	/**
	 ...
	 */
	addFeatureVariant(feature: Feature$2, target: QrfTarget, availableImages?: ImageId[]): void;
	appendToResult(result: QueryResult, layerID: string, featureIndex: number, geojsonFeature: Feature$2, intersectionZ?: number): void;
...
type BucketParameters<Layer extends StyleLayer> = {
	index: number;
	layers: Array<Layer>;
	zoom: number;
	lut: LUT$1 | null;
...
type RuntimeModuleType = "HD" | "Standard";
...
declare class StyleLayer extends Evented {
	...
	queryRenderedFeatures(queryGeometry: QueryGeometry, sourceCache: SourceCache, transform: Transform): QueryResult;
	queryRadius(_bucket: Bucket): number | undefined;
	queryIntersectsFeature(_queryGeometry: TilespaceQueryGeometry, _feature: VectorTileFeature, _featureState: FeatureState, _geometry: Array<Array<Point>>, _zoom: number, _transform: Transform, _pixelPosMatrix: Float32Array, _elevationHelper: DEMSampler | null | undefined, _layoutVertexArrayOffset: number, scope: string | undefined): boolean | number | undefined;
}
type PaintProps$11 = {
...
declare class ClipStyleLayer extends StyleLayer {
	...
	constructor(layer: LayerSpecification, scope: string, lut: LUT$1 | null, options?: ConfigOptions | null);
	recalculate(parameters: EvaluationParameters, availableImages: ImageId[]): void;
	createBucket(parameters: BucketParameters<this>): ClipBucket;
	is3D(terrainEnabled?: boolean): boolean;
}
type PaintProps$13 = {
...
declare class SkyLayer extends StyleLayer {
	type: "sky";
...
type FeaturelessStyleLayer = ClipStyleLayer | SlotStyleLayer;
type CoreStyleLayer = BackgroundStyleLayer | CircleStyleLayer | CustomStyleLayer | FillExtrusionStyleLayer | FillStyleLayer | HeatmapStyleLayer | HillshadeStyleLayer | LineStyleLayer | RasterStyleLayer | SkyLayer | SymbolStyleLayer;
type HDStyleLayer = BuildingStyleLayer | RasterParticleStyleLayer;
type StandardStyleLayer = ModelStyleLayer;
type TypedStyleLayer = CoreStyleLayer | HDStyleLayer | StandardStyleLayer | FeaturelessStyleLayer;
type BinderUniform = {
	name: string;
	property: string;
...
interface AttributeBinder {
	...
	populatePaintArray: (length: number, feature: Feature$1, imagePositions: SpritePositions, availableImages: ImageId[], canonical?: CanonicalTileID, brightness?: number | null, formattedSection?: FormattedSection, worldview?: string) => void;
	updatePaintArray: (start: number, length: number, feature: Feature$1, featureState: FeatureState, availableImages: ImageId[], imagePositions: SpritePositions, brightness: number, worldview: string | undefined) => void;
...
declare class ProgramConfiguration {
	...
	updateExpressions(layer: TypedStyleLayer): void;
	getMaxValue(property: string): number;
	populatePaintArrays(newLength: number, feature: Feature$1, imagePositions: SpritePositions, availableImages: ImageId[], canonical?: CanonicalTileID, brightness?: number | null, formattedSection?: FormattedSection, worldview?: string): void;
...
declare class ProgramConfigurationSet<Layer extends TypedStyleLayer> {
	...
	populatePaintArrays(length: number, feature: Feature$1, index: number, imagePositions: SpritePositions, availableImages: ImageId[], canonical: CanonicalTileID, brightness?: number | null, formattedSection?: FormattedSection, worldview?: string): void;
...
declare class Program$1<Us extends UniformBindings> {
	...
	constructor(context: Context, name: ProgramName, source: ShaderSource, configuration: ProgramConfiguration | null | undefined, fixedUniforms: (arg1: Context) => Us, fixedDefines: DynamicDefinesType[], precompiled?: boolean);
	_finalize(): void;
	maybeFinalize(): void;
	_ensureReady(): void;
...
declare class Tile {
	...
	evaluateQueryRenderedFeaturePadding(): number;
	queryRenderedFeatures(query: QrfQuery, tilespaceGeometry: TilespaceQueryGeometry, availableImages: ImageId[], transform: Transform, sourceCacheTransform: Transform, visualizeQueryGeometry: boolean, scope: string | undefined): QueryResult;
	querySourceFeatures(result: Array<Feature$2>, params?: {
		sourceLayer?: string;
		filter?: FilterSpecification;
		validate?: boolean;
	}): void;
	...
	_makeDebugTileBoundsBuffers(context: Context, projection: Projection$1): void;
	_makeTileBoundsBuffers(context: Context, projection: Projection$1): void;
...
export declare class ModelSource extends Evented<SourceEvents> implements ISource {
	...
	private loadModel;
	load(): Promise<void>;
	private static arrayFromColorSpecification;
...
type SourceClass = Class<ISource>;
...
export type RequestTransformFunction = (url: string, resourceType?: ResourceType$1, options?: {
	signal?: AbortSignal;
...
declare class RequestManager {
	...
	transformRequest(url: string, type: ResourceType$1, abortSignal?: AbortSignal): Promise<RequestParameters>;
 ...
 * @private
 */
export declare function setSdkInfo(info: string): void;
declare class Hash {
...
declare class Camera extends Evented<MapEvents> {
	 ...
	 */
	stop(): this;
	_requestRenderFrame(_callback: () => void): TaskID | undefined;
	...
	_emulate(frame: (Transform: any) => (number: any) => Transform, duration: number, initialTransform: Transform): Array<Transform>;
	_preloadTiles(_transform: Transform | Array<Transform>, _callback?: Callback<Tile[]>): void;
}
...
declare class InteractionSet {
	...
	handleType(event: MapMouseEvent, features?: Feature$2[]): void;
}
...
declare class Map$1 extends Camera {
	 ...
	 */
	setLayerProperty<K extends keyof LayerProperty>(layerId: string, name: K, value: LayerProperty[K], options?: StyleSetterOptions): this;
	...
	******************************************************************************/
	...
	get showElevationIdDebug(): boolean;
...
export declare class GeolocateControl extends Evented<GeolocateControlEvents> implements IControl {
	...
	_setWatchState(state: WatchState): void;
	_setButtonTitle(stringKey: Parameters<Map$1["_getUIString"]>[0]): void;
	_setErrorState(): void;
	/**
	...
	*/
	...
	_removeDeviceOrientationListener(): void;
	_createUserLocationMarkers(): void;
	_clearWatch(): void;
}
 ...
 */
export declare class IndoorControl implements IControl {
	_map: Map$1 | null;
...
export declare function setBaseApiUrl(url: string): void;
export declare function setMaxParallelImageRequests(numRequests: number): void;
export declare function getDracoUrl(): string;
export declare function setDracoUrl(url: string): void;
export declare function getMeshoptUrl(): string;
export declare function setMeshoptUrl(url: string): void;
export declare function getBuildingGenUrl(): string;
export declare function setBuildingGenUrl(url: string): void;
/**
...
declare function clearTileCache(callback?: (err?: Error | null) => void): void;
export declare const setNow: (time: number) => void, restoreNow: () => void;
...
export {
	...
	clearTileCache as clearStorage,
